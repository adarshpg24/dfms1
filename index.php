...
<input class="form-control" placeholder="Password" type="password" name="password" required="true" id="textbox2">
...
<button class="btn btn-warning btn-block" type="submit" name="login" id="btn1">Login</button>
